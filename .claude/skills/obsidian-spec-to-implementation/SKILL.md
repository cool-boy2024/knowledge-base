...
description: "Use when translating a spec or requirements doc into implementation tasks, or user says 'plan implementation of X', 'break down this spec', 'create tasks from spec'"
---
