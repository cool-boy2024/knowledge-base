...
> Reference documentation from Anthropic. Source: https://code.claude.com/docs/en/skills
> This file helps Claude Code understand the skill system when creating or modifying skills via /skill-creator.
